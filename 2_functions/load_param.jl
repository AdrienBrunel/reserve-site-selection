...
# ==============================================================================
    ...
    ## DataFrame ---------------------------------------------------------------
        ...
        var_name = ["spec_nb","BLM","optim_type","cost_type","lon_range","lon_resol","lat_range","lat_resol","locked_out","locked_in"]
        ...
        close(fid)
        param_data = DataFrame([spec_nb BLM optim_type cost_type lon_range lon_resol lat_range lat_resol locked_out locked_in])
        rename!(param_data,["spec_nb","BLM","optim_type","cost_type","lon_range","lon_resol","lat_range","lat_resol","locked_out","locked_in"])
