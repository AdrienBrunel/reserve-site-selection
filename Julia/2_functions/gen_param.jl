...
# ==============================================================================
    ...
    ## Generation --------------------------------------------------------------
        ...
        param_data = Array{String,2}(undef,max_length,10)
        ...
        cpt = 0
        var_name = ["spec_nb" "BLM" "cost_type" "optim_type" "lon_range" "lon_resol" "lat_range" "lat_resol" "locked_out" "locked_in"]
        ...
        rename!(param_data,["spec_nb","BLM","cost_type","optim_type","lon_range","lon_resol","lat_range","lat_resol","locked_out","locked_in"])

        param_fname = string(sc_dir,"/param.csv")
        fid = open(param_fname,"w")
        str    = Array{String,1}(undef,10)
