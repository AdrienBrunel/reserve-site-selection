...
# ===========================================================================
  ...
  # MPA ---------------------------------------------------------------------
    ...
    # parc.marin.data = as.data.frame(getKMLcoordinates(kmlfile=parc.marin.fname,ignoreAltitude=TRUE))
    # parc.marin.fname = paste0(root.dir,"/1_data/noronha/Parc marin FN.kml")
